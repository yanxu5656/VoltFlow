// 主控制大厅：渲染任务列表与完成键，呈现电池核心、通知系统与简易趋势图
import QtQuick
...
Item {
    ...
    Rectangle {
        id: rect_tasks
        x: 50; y: 60; width: 470; height: 480
        color: "#8ED9F6"; border.color: "#1ABC9C"; border.width: 4
        Text { x: 20; y: 15; text: "自定义任务列表"; color: "#FFFFD6"; font.pixelSize: 24; font.bold: true }
        Rectangle {
            x: 20; y: 60; width: 430; height: 400; color: "#ADCEC8"; border.color: "#1ABC9C"; border.width: 2
            ListView {
                anchors.fill: parent; anchors.margins: 10; model: taskManager.userTasks; clip: true
                delegate: Rectangle {
                    width: parent.width; height: 75; color: "transparent"
                    Rectangle { anchors.fill: parent; color: modelData.is_rec === 1 ? "#33FFD700" : "transparent"; radius: 4 }
                    Column {
                        anchors.verticalCenter: parent.verticalCenter; x: 10
                        Text { text: (modelData.is_rec === 1 ? "💡[推荐] " : "📌 ") + modelData.name; color: "#FFFFD6"; font.pixelSize: 16; font.bold: true }
                        Text { text: "⚡能量: +" + modelData.energy_reward + " | 🗓️时间: " + Qt.formatDateTime(modelData.deadline, "yyyy-MM-dd hh:mm"); color: "#1ABC9C"; font.pixelSize: 13 }
                    }
                    Button {
                        id: btn_done
                        anchors.right: parent.right; anchors.rightMargin: 10; anchors.verticalCenter: parent.verticalCenter
                        width: 70; height: 35; text: "完成"
    ...
    Rectangle {
        id: rect_recs
        x: 50; y: 560; width: 470; height: 320
        color: "#8ED9F6"; border.color: "#1ABC9C"; border.width: 4
        Text { x: 20; y: 15; text: "系统推荐列表"; color: "#FFFFD6"; font.pixelSize: 24; font.bold: true }
        Rectangle {
            x: 20; y: 60; width: 430; height: 240; color: "#ADCEC8"; border.color: "#1ABC9C"; border.width: 2
            ListView {
                anchors.fill: parent; anchors.margins: 10; model: taskManager.sysRecs; clip: true
                delegate: Rectangle {
                    width: parent.width; height: 45; color: "transparent"
                    Text { anchors.verticalCenter: parent.verticalCenter; x: 10; text: "💡 " + modelData.name; color: "#FFFFD6"; font.pixelSize: 16 }
                }
            }
        }
    }
    ...
    Shape {
        ...
        ShapePath {
            strokeColor: "#1ABC9C"; strokeWidth: 5; fillColor: "#ADCEC8"
            startX: liubianxing.width / 2; startY: 10
    ...
    Item {
        ...
        Rectangle {
            anchors.fill: parent
            color: "transparent"; border.color: taskManager.isSuperCharged ? "#FFD700" : "#1ABC9C"
            border.width: 4; radius: 8
            Rectangle {
                width: 40; height: 12; color: parent.border.color
            ...
            Rectangle {
                ...
                height: (parent.height - 16) * (qMin(taskManager.currentEnergy, 100) / 100.0)
                color: taskManager.isSuperCharged ? "#FFD700" : "#1ABC9C"; radius: 4
        ...
        PropertyAnimation {
            target: core_battery; property: "opacity"; from: 0.6; to: 1.0
            duration: 800; running: taskManager.isSuperCharged; loops: Animation.Infinite
        }
    }
    ...
    Rectangle {
        ...
        anchors.bottom: liubianxing.top; anchors.bottomMargin: -20
        color: window.isReviewAlert ? "#FF6B6B" : "#FFBE76"
        radius: 12; visible: window.alertMsg !== ""
        border.color: "#FFFFD6"; border.width: 2
        Text {
            anchors.fill: parent; anchors.margins: 10
            text: window.alertMsg; color: "#FFFFD6"
            font.pixelSize: 14; font.bold: true; wrapMode: Text.WordWrap
            verticalAlignment: Text.AlignVCenter
        }
        Text {
            text: "✖"; color: "#FFFFD6"; font.pixelSize: 14
            anchors.top: parent.top; anchors.right: parent.right; anchors.topMargin: 6; anchors.rightMargin: 8
    ...
    Rectangle {
        id: rect_chart
        x: 1080; y: 300; width: 470; height: 580
        color: "#8ED9F6"; border.color: "#1ABC9C"; border.width: 4
        ...
        Row {
            ...
            Repeater {
                model: [40, 65, 80, 50, 95, 70, taskManager.currentEnergy]
                Rectangle {
                    width: 25; height: qMin(modelData, 120) * 4
                    color: index === 6 ? (taskManager.isSuperCharged ? "#FFD700" : "#1ABC9C") : "#1ABC9C"; radius: 4
                    Text { text: modelData; anchors.bottom: parent.top; anchors.horizontalCenter: parent.horizontalCenter; color: "#FFFFD6"; font.pixelSize: 11 }
                }
            }
        }
    }
    ...
    Rectangle {
        x: 630; y: 20; width: 340; height: 45; color: "#ADCEC8"; radius: 6
        Text {
            ...
            color: "#FFFFD6"; font.pixelSize: 16; font.bold: true
        }
        Button {
            anchors.right: parent.right; anchors.rightMargin: 10; anchors.verticalCenter: parent.verticalCenter
            text: "+1小时演示"; onClicked: taskManager.addDemoTime(1)
        }
    }

    Rectangle {
        id: rect_weekly; x: 575; y: 755; width: 150; height: 90; color: "#8ED9F6"; border.color: "#1ABC9C"; border.width: 4
    ...
    Rectangle {
        id: rect_total; x: 875; y: 755; width: 150; height: 90; color: "#8ED9F6"; border.color: "#1ABC9C"; border.width: 4
    ...
    Shape {
        id: sanjiaoxing_zuo; width: 1600; height: 900
